...
static bool blackboxWriteSysinfo(void)
{
    ...
    switch (xmitState.headerIndex) {
        ...
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_GPS_RESCUE_ALLOW_EXTERNAL_HOME, "%d", gpsRescueConfig()->allowExternalHome);
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_GPS_RESCUE_MAX_HOME_DISTANCE, "%d", gpsRescueConfig()->maxHomeDistanceM);
        BLACKBOX_PRINT_HEADER_LINE(PARAM_NAME_GPS_RESCUE_MAX_PDOP, "%d", gpsRescueConfig()->maxPdop);
