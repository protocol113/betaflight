...
// PG_GPS_CONFIG
    ...
    { PARAM_NAME_GPS_RESCUE_ALLOW_EXTERNAL_HOME, VAR_UINT8 | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, allowExternalHome) },
    { PARAM_NAME_GPS_RESCUE_MAX_HOME_DISTANCE, VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 100, 10000 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, maxHomeDistanceM) },
    { PARAM_NAME_GPS_RESCUE_MAX_PDOP, VAR_UINT8 | MASTER_VALUE, .config.minmaxUnsigned = { 10, 100 }, PG_GPS_RESCUE, offsetof(gpsRescueConfig_t, maxPdop) },
